...
it('seeds the complete sport discovery demo dataset idempotently', function () {
    ...
    expect(Sport::query()->count())->toBe(20)
        ...
        ->and(SportSession::query()->where('city', 'Florianopolis')->where('region', 'SC')->count())->toBe(20)
        ->and(SportSession::query()->whereBetween('latitude_approx', [-27.612, -27.583])->count())->toBe(20)
        ->and(SportSession::query()->whereBetween('longitude_approx', [-48.531, -48.503])->count())->toBe(20)
