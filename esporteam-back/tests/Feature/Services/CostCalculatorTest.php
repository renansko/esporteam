...
it('sums tokens used this month for a workspace', function () {
    ClusteringRun::factory()->create(['workspace_id' => 1, 'token_usage_in' => 100, 'token_usage_out' => 200]);
    ClusteringRun::factory()->create(['workspace_id' => 1, 'token_usage_in' => 50,  'token_usage_out' => 60]);
    ClusteringRun::factory()->create(['workspace_id' => 2, 'token_usage_in' => 999, 'token_usage_out' => 999]);
...
it('reports over budget when consumption >= configured budget', function () {
    ...
    ClusteringRun::factory()->create(['workspace_id' => 7, 'token_usage_in' => 300, 'token_usage_out' => 200]);
